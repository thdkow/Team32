...
<div class="container">
	...
	<div class="row">
		...
		<div class="col-lg-9 my-5">
			...
			<div class="row my-5">
				<form class="" action="/Question/QuestionWriteAction.dobby" method="post">
					<fieldset>
						...
						<div class="form-group">
							...
							<div class="col-md-8">
								<label for="filter">문의제목</label> <input id="qsubject"
						...
						<div class="form-group">
							...
							<div class="col-md-8">
								<label for="filter">문의내용</label>
								<textarea class="form-control" id="qcontent" name="qcontent"
									placeholder="문의 내용을 정확히 입력해주세요." rows="7" size="120"></textarea>
							</div>
						</div>
						...
						<div class="form-group">
							<div class="col-md-12 text-xs-center">
								...
								<a class="btn btn-danger btn-lg" href="/Question/QuestionList.dobby">취소</a>
							</div>
						</div>
					</fieldset>
				</form>
