...
public interface MemberService_Mapper {
	...
	public MemberVo checkGB1(HashMap<String, Object>hm); //중복 추천 확인1
	
	public void insertGB(HashMap<String, Object>hm); // 중복확인 테이블에 추가
	
	public void updateGB(HashMap<String, Object>hm); // 멤머 추처누 업데이드
